...
class SQLiteRunStore:
    ...
    SQLite keeps the demo self-contained. The interface is intentionally narrow so
    a production deployment can replace it with PostgreSQL without changing the
    runtime manager or API contract.
    """
